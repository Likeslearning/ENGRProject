...
<html>
  ...
  <table align="center">
	<tr>
		<td>
		<input type="number" min="0" onkeypress="return event.charCode >= 48" class="inputs" name="value3" id="value3" value="0"/>
			<select name="from3" id="from3" class="selects">
		...
		<input type="text" name="result3" id="result3" class="inputs" value="—" readonly/>
			<select name="to3" id="to3" class="selects">
...
<br><br><br><br><br><br>
        <div style="margin-right: 300px;">
            <form name="showform3" id="showform3" action="Area_Records.php" method="POST">
                ...
                <input type="text" name="showfrom3" id="showfrom3" class="inputs"/>
                &nbsp; &nbsp;

                <label style="color: white;">To Unit:</label>
                <input type="text" name="showto3" id="showto3" class="inputs"/>
                <br>
                <br>
                <input type="submit" name="show3" id="show3" class="button3" value="Show Previous Records"/>
            </form>
        </div>
</body>
