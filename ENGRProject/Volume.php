  ...
  <table align="center">
	<tr>
		...
		<input type="number" min="0" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) ||  
                        event.charCode === 46 || event.charCode === 0" class="inputs" name="value4" id="value4" value="0"/>
			<select name="from4" id="from4" class="selects4">
		...
		<input type="text" name="result4" id="result4" class="inputs" value="—" readonly/>
			<select name="to4" id="to4" class="selects4">
                ...
                <table align="center">
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="showfrom4" id="showfrom4" class="selects4">
				<option value="">To Cubic Unit</option>
				<option value="Kilometer Cube">Kilometer Cube</option>
				<option value="Hectometer Cube">Hectometer Cube</option>
				<option value="Decameter Cube">Decameter Cube</option>
				...
				<option value="Gallon">Gallon</option>
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="showto4" id="showto4" class="selects4">
				<option value="">To Cubic Unit</option>
				<option value="Kilometer Cube">Kilometer Cube</option>
				<option value="Hectometer Cube">Hectometer Cube</option>
				<option value="Decameter Cube">Decameter Cube</option>
...
function reset(){
	...
	lblResult.value = "—";
        ...
        let showFrom = document.getElementById("showfrom4");
	showFrom.value = "";
        
        let showTo = document.getElementById("showto4");
	showTo.value = "";
}
