...
<body class="content8">
  ...
  <table align="center">
	<tr>
		...
		<select name="from8" id="from8" class="selects"></select>
            </td>
		...
		<select name="to8" id="to8" class="selects"></select>
            </td>
	</tr>
    ...
    <br><br><br><br>
        <div align="center">
            <form name="showform8" id="showform8" action="Money_Records.php" method="POST">
                <label style="color: black;">From Unit:</label>
                <input type="text" name="showfrom8" id="showfrom8" class="inputs"/>
                &nbsp; &nbsp;

                <label style="color: black;">To Unit:</label>
                <input type="text" name="showto8" id="showto8" class="inputs"/>
                <br>
                <br>
...
function clicked(){
    ...
    }) // Printing the exchange value(comes from API) inside the label
    .catch(error => console.log('error', error));
