...
<body class="content6">
  ...
  <table align="center">
	<tr>
		<td>
		<input type="number" min="0" onkeypress="return event.charCode >= 48" class="inputs" name="value6" id="value6" value="0">
			<select name="from6" id="from6" class="selects">
		...
		<input type="text" name="result6" id="result6" class="inputs" value="—" readonly/>
			<select name="to6" id="to6" class="selects">
...
<br><br><br><br>
        <div style="margin-right: 300px;">
            <form name="showform6" id="showform6" action="Weight_Records.php" method="POST">
                ...
                <input type="text" name="showfrom6" id="showfrom6" class="inputs"/>
                &nbsp; &nbsp;

                <label style="color: black;">To Unit:</label>
                <input type="text" name="showto6" id="showto6" class="inputs"/>
                <br>
                <br>
