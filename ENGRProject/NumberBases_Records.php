...
<html>
    <body class="content5">
        ...
        if($show_from != "" && $show_to != "") {
            $sql = "select * from number_bases where from_unit='".$show_from."' and to_unit='".$show_to."' limit 10";
            $result = mysqli_query($conn, $sql);
            ?>

            <table border="3" style="text-align: center; font-size: 25px; color: black; background-image: linear-gradient(#ffa535,#ffd935);">
                <tr>
