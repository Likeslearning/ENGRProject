...
<html>
    <body class="content2">
        ...
        if($show_from != "" && $show_to != "") {
            $sql = "select * from length where from_unit='".$show_from."' and to_unit='".$show_to."' order by id desc limit 20";
            ...
            $sql = "select * from length where from_unit='".$show_from."' order by id desc limit 20";
            $result = mysqli_query($conn, $sql);
            ?>
            ...
            $sql = "select * from length where to_unit='".$show_to."' order by id desc limit 20";
            $result = mysqli_query($conn, $sql);
            ?>
            ...
            $sql = "select * from length order by id desc limit 20";
            $result = mysqli_query($conn, $sql);
            ?>
