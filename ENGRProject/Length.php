      ...
      <table align="center">
            <tr>
                    ...
                    <input type="number" min="0" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) ||  
                        event.charCode === 46 || event.charCode === 0" class="inputs" name="value2" id="value2" value="0">
                            <select name="from2" id="from2" class="selects2">
                    ...
                    <input type="text" name="result2" id="result2" class="inputs" value="—" readonly/>
                            <select name="to2" id="to2" class="selects2">
                ...
                <table align="center">
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="showfrom2" id="showfrom2" class="selects2">
                                <option value="">From Length Unit</option>
                                <option value="Kilometer">Kilometer</option>
                                <option value="Hectometer">Hectometer</option>
                                <option value="Decameter">Decameter</option>
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="showto2" id="showto2" class="selects2">
                                <option value="">From Length Unit</option>
                                <option value="Kilometer">Kilometer</option>
                                <option value="Hectometer">Hectometer</option>
                                <option value="Decameter">Decameter</option>
