...
<html>
    <body class="content8">
        ...
        if($show_from != "" && $show_to != "") {
            $sql = "select * from money where from_unit='".$show_from."' and to_unit='".$show_to."' limit 10";
            $result = mysqli_query($conn, $sql);
            ?>

            <table border="3" style="text-align: center; font-size: 25px; color: white; background-image: linear-gradient(#00a1e9, #002ce9);">
                <tr>
