...
<body class="content5">
  ...
  <table align="center">
	<tr>
		<td>
		<input type="number" class="inputs" name="value5" id="value5" value="0">
			<select name="from5" id="from5" class="selects">
		...
		<input type="text" name="result5" id="result5" class="inputs" value="—" readonly/>
			<select name="to5" id="to5" class="selects">
                            <option value="">From Number Base</option>
                            <option value="Binary">Binary</option>
                            <option value="Octal">Octal</option>
                            <option value="Decimal">Decimal </option>
...
<br><br><br><br>
        <div style="margin-right: 300px;">
            <form name="showform5" id="showform5" action="NumberBases_Records.php" method="POST">
                ...
                <input type="text" name="showfrom5" id="showfrom5" class="inputs"/>
                &nbsp; &nbsp;

                <label style="color: white;">To Unit:</label>
                <input type="text" name="showto5" id="showto5" class="inputs"/>
                <br>
                <br>
