  ...
  <table align="center">
	<tr>
		...
		<input type="number" min="1" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) ||  
                        event.charCode === 46 || event.charCode === 0" class="inputs" name="value7" id="value7" value="0">
			<select name="from7" id="from7" class="selects7">
		...
		<input type="text" name="result7" id="result7" class="inputs" value="—" readonly/>
			<select name="to7" id="to7" class="selects7">
				<option value="">From Time Unit</option>
				<option value="Year">Year</option>
				<option value="Month">Month</option>
				<option value="Day">Day </option>
                ...
                <table align="center">
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="showfrom7" id="showfrom7" class="selects7">
				<option value="">From Time Unit</option>
				<option value="Year">Year</option>
				<option value="Month">Month</option>
				<option value="Day">Day </option>
				...
				<option value="Millisecond">Millisecond</option>
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="showto7" id="showto7" class="selects7">
				<option value="">From Time Unit</option>
				<option value="Year">Year</option>
				<option value="Month">Month</option>
				<option value="Day">Day </option>
...
function reset(){
	...
	lblResult.value = "—";
        ...
        let showFrom = document.getElementById("showfrom7");
	showFrom.value = "";
        
        let showTo = document.getElementById("showto7");
	showTo.value = "";
