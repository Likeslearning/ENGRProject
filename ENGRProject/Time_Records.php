...
<html>
    <body class="content7">
        ...
        if($show_from != "" && $show_to != "") {
            $sql = "select * from time where from_unit='".$show_from."' and to_unit='".$show_to."' limit 10";
            $result = mysqli_query($conn, $sql);
            ?>

            <table border="3" style="text-align: center; font-size: 25px; color: black; background-image: linear-gradient(#dcdc00,#ff7500);">
                <tr>
